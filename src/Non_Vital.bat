...
start /wait %ldrapath1%\tbini.exe -Section="C/C++ LDRA Testbed" SYSEARCH_FILE="%vvpath%\sysearch_VPMC.dat"

start /wait %ldrapath1%\tbini.exe -Section="C/C++ LDRA Testbed" SYSPPVAR_FILE="%vvpath%\sysppvar_VPMC.dat"

rem Coverage Settings

start /wait %ldrapath1%\tbini.exe -Section="C/C++ LDRA Testbed" DYNAMIC_REPORT_CONFIGURATION=Custom

start /wait %ldrapath1%\tbini.exe -Section="C/C++ LDRA Testbed" DEFAULT_CUSTOM_SETTINGS="0 1 1 0 0 0 0 1"
